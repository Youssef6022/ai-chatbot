...
export const Response = memo(
  ({ className, isStreaming = false, children, ...props }: ResponseProps) => {
    ...
    return (
      <Streamdown
        className={cn(
          'size-full text-left [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&_code]:whitespace-pre-wrap [&_code]:break-words [&_div]:text-left [&_h1]:text-left [&_h2]:text-left [&_h3]:text-left [&_ol]:text-left [&_p]:text-left [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_ul]:text-left',
          className,
        )}
        {...props}
      >
